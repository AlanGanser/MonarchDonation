...
const AdminNavbar = ({ children }: { children: React.ReactNode }) => {
    ...
    const navigation: { name: string; href: string; icon: IconType; current?: boolean }[] = [
        { name: "Home", href: "/admin", icon: HiOutlineHome, current: currentPage === "/admin" },
        { name: "Donations", href: "/admin/donations", icon: HiOutlineCalendar, current: currentPage === "/admin/donations",
        },
    ];
