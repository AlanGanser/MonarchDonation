...
const Mail = () => {
    return (
        ...
        // <div id="mail" className="relative bg-white">
        //   <div className="absolute inset-0">
        //     <div className="absolute inset-y-0 left-0 w-1/2 bg-gray-50" />
        //   </div>
        //   <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        ...
        //               id="full-name"
        //               autoComplete="name"
        //               className="block w-full rounded-md border-gray-300 px-4 py-3 placeholder-gray-500 shadow-sm focus:outline-secondary"
        //               placeholder="Full name"
        //             />
        //           </div>
        //           <div>
